  ...
  return (
    <div className="glass-panel" style={{ padding: '24px', display: 'flex', flexDirection: 'column', height: '100%' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px' }}>
        ...
        <h3 style={{ fontSize: '1.15rem', color: '#ffffff', fontWeight: 700 }}>Suggested Moves</h3>
      </div>
      ...
      {!isBackendOnline && (
        <div style={{
          ...
          <AlertCircle size={14} />
          <span>Backend standby on http://127.0.0.1:8000</span>
        </div>
      )}
      ...
      <div style={{
        ...
        <Lightbulb size={18} color="var(--accent-amber)" style={{ marginTop: '2px', flexShrink: 0 }} />
        <div>
          <span style={{ fontSize: '0.8rem', fontWeight: 700, color: '#fbbf24', display: 'block', marginBottom: '2px' }}>
            Tip
          </span>
